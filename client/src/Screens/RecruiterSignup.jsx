...
const RecruiterSignup = () => {
  ...
  const handleOAuth = (provider) => {
    ...
    const OAUTH_URLS = {
      google: `${API_BASE}/auth/google?role=recruiter`,
      github: `${API_BASE}/auth/github?role=recruiter`,
    };
    ...
    const handleMessage = (event) => {
      ...
      if (event.data?.user) {
        ...
        const redirectUrl =
          event.data.user.role === "recruiter"
            ? "/recruiter/dashboard"
                  ...
                  {showPassword ? (
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L12 12m-2.122-2.122L7.758 7.758M12 12l2.122-2.122m-2.122 2.122L7.758 16.242"
                      />
                    </svg>
                  ) : (
                    <svg
