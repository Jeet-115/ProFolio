      ...
      {techStack === "HTML-CSS-JS" && (
        <div className="hidden lg:flex gap-4">
          ...
          <button
            ...
            className="group relative flex items-center justify-start w-[45px] h-[45px] rounded-full overflow-hidden transition-all duration-300 shadow-[2px_2px_10px_rgba(0,0,0,0.2)] bg-[#E34F26] active:translate-x-[2px] active:translate-y-[2px]"
          ...
          >
            ...
            <span className="absolute right-0 w-0 opacity-0 text-white font-semibold text-base transition-all duration-300 group-hover:opacity-100 group-hover:w-[105px] pr-3 text-right">
              Index.html
            </span>
            <style>{`.group:hover{width:150px;border-radius:40px}.group:hover div{width:30%;padding-left:10px}`}</style>
          </button>
          ...
          <button
            ...
            className="group relative flex items-center justify-start w-[45px] h-[45px] rounded-full overflow-hidden transition-all duration-300 shadow-[2px_2px_10px_rgba(0,0,0,0.2)] bg-[#1572B6] active:translate-x-[2px] active:translate-y-[2px]"
          ...
          <button
            ...
            className="group relative flex items-center justify-start w-[45px] h-[45px] rounded-full overflow-hidden transition-all duration-300 shadow-[2px_2px_10px_rgba(0,0,0,0.2)] bg-[#F7DF1E] active:translate-x-[2px] active:translate-y-[2px]"
          ...
          >
            ...
            <span className="absolute right-0 w-0 opacity-0 text-black font-semibold text-base transition-all duration-300 group-hover:opacity-100 group-hover:w-[105px] pr-3 text-right">
              Script.js
            </span>
            <style>{`.group:hover{width:150px;border-radius:40px}.group:hover div{width:30%;padding-left:10px}`}</style>
          </button>
